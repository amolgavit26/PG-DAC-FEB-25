...
namespace DatabaseCode
{
    internal class Program
    {
        static void Main1()
        {
            ...
            Employee obj = new Employee { EmpNo = 8, Name = "Robin Paswan", DeptNo = 30, Basic = 32500 };
            //Insert2(obj);
        ...
        static void Main()
        {
            ...
            var lstEmps = GetAllEmployees();
            for (int i = 0; i < lstEmps.Count; i++)
            {
                Console.WriteLine("EmpNo: " + lstEmps[i].EmpNo);
                Console.WriteLine("Name: " + lstEmps[i].Name);
                Console.WriteLine("Basic: " + lstEmps[i].Basic);
                Console.WriteLine("DeptNo: " + lstEmps[i].DeptNo);
                Console.WriteLine("-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-");
            }
        }
        ...
        static void SelectASingleValue()
        {
            ...
            try
            {
                ...
                object retval = cmd.ExecuteScalar();    //returns first row, first col
